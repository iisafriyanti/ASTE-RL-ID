...
class Parser(object):
    def getParser(self):
        ...
        parser.add_argument('--epochPRE', type=int, default=3, help="Number of epoch on pretraining")
        parser.add_argument('--epochRL', type=int, default=3, help="Number of epoch on training with RL")
        ...
        parser.add_argument('--datapath', type=str, default='/content/drive/MyDrive/DOKTORAL/PML/rl-project/data/ASTE-Data-V2-EMNLP2020/14lap/', help="Data directory")
